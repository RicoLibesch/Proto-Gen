...
import { User, getUsers, removeRole, setRole, store } from "@/utils/API";
  ...
  const renderUsers = () => {
    if (loading) {
      ...
      return array.map((_, index) => (
        <div
          key={index}
          className="flex items-center flex-nowrap my-2 border rounded-xl border-outline p-2 hover:shadow hover:cursor-pointer truncate transition-all fadein"
        >
          <Skeleton
